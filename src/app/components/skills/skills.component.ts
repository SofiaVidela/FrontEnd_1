...
export class SkillsComponent implements OnInit {
  ...
  hSArray: Skill[]= [];
  hardSkill: Skill = null; 

  constructor(private personaService:PersonaService,private hSService: SkillService,
  ...
  onCreateHS(): void {
    const hardSkill = new Skill(this.nombreHS, this.porcentajeHS, this.descripcionHS);
